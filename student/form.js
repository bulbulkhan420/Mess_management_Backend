...
appi.post('/paymentdone',verify,async (req,res)=>{
  ...
  const data = {
    ...
    fail_url: `https://mess-management-backend.onrender.com/payment/fail/${req.body._id}/${req.body.email}/${"Not_paid"}`,
    cancel_url: `https://mess-management-backend.onrender.com/payment/fail/${req.body._id}/${req.body.email}/${"Not_paid"}`,
...
appi.post('/month/payment',verify,async (req,res)=>{
  ...
  const data = {
    ...
    currency: 'BDT',
    tran_id: tran_id, // use unique tran_id for each api call
    success_url: `https://mess-management-backend.onrender.com/payment/success/rent/${_id}/${tran_id}`,
    fail_url: 'https://mess-management-backend.onrender.com/payment/fail/rent',
    cancel_url: 'https://mess-management-backend.onrender.com/payment/cancel/rent',
    ipn_url: 'http://localhost:3030/ipn',
    shipping_method: 'Courier',
    product_name: 'Payment of seat booking',
    product_category: 'mess seat',
